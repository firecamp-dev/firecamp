...
// const TemplateWithVariant = ({ variant }: { variant: IButton[] }) => (
...
//     const PrimaryButtonArgs: IButton = {
//       text: 'Primary Button',
//       primary: true,
//       md: true,
//     };
...
//         'text-primaryColor !border-primaryColor hover:bg-primaryColor'
//       );
//       if (!PrimaryButtonArgs.ghost) {
//         expect(button).toHaveClass(
//           'text-primaryColor-text bg-primaryColor !border-primaryColor'
//         );
//       }
...
//     const SecondaryButtonArgs: IButton = {
...
//       expect(button).toHaveClass(
//         'text-secondaryColor-text bg-secondaryColor !border-secondaryColor'
//       );
//     }
//   });

//   test('Danger button should render', () => {
//     const DangerButtonArgs: IButton = {
//       text: 'Danger Button',
//       danger: true,
//       md: true,
//     };
...
//       expect(button).toHaveClass(
//         'text-secondaryColor-text bg-danger !border-danger'
//       );
//     }
//   });

//   test('Transparent button should render', () => {
//     const TransparentButtonArgs: IButton = {
...
//       name: TransparentButtonArgs.text,
//     });
...
//     const FullWidthButtonArgs: IButton = {
...
//     const ButtonWithUpperCaseTextComponentArgs: IButton = {
...
//     let button = screen.getByRole('button', {
//       name: ButtonWithUpperCaseTextComponentArgs.text,
//     });
...
//     ButtonSizesArgs.variant.forEach(
//       (element: { text: string }, index: number) => {
...
//     ButtonIconPosition.variant.forEach(
//       (
//         element: { text: string; iconLeft: boolean; iconRight: boolean },
//         index: number
//       ) => {
