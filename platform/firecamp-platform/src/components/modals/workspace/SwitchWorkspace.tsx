...
const WorkspaceCard = ({ workspace, onClick }) => {
  return (
    <div
      onClick={onClick}
      className="card relative flex items-center p-3 mb-2 text-base border border-app-border cursor-pointer hover:border-focusBorder  after:content-['_↗']  after:absolute after:top-0 after:left-0 after:bottom-0 after:right-0 hover:after:bg-focusBorder after:opacity-10 "
    >
      <div className="z-10 w-full">
        <div className="flex border-b border-app-border pb-2 items-center">
